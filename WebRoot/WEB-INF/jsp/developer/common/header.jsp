        ...
        <div class="col-md-3 left_col menu_fixed">
          <div class="left_col scroll-view">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-edit"></i> APP应用管理<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="form.html">APP发布</a></li>
                    </ul>
                  </li>
                </ul>
              </div>
            ...
            <div class="sidebar-footer hidden-small">
              ...
              <a data-toggle="tooltip" data-placement="top" title="Logout" href="${pageContext.request.contextPath }/dev/logout">
